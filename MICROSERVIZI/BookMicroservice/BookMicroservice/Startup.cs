...
namespace BookMicroservice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "BookMicroservice", Version = "v1" });
            });
            services.AddDbContext<BookContext>(op => op.UseSqlServer(Configuration.GetConnectionString("Database"),
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "BookMicroservice v1"));
